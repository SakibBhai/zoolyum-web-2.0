...
import { generateSlug } from "@/lib/service-operations";
...
export default function NewCampaignPage() {
  ...
  const handleInputChange = (field: string, value: any) => {
    ...
    // Handle real-time slug generation from title
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className={isSlugAutoGenerated ? 'border-green-300 bg-green-50/10' : ''}
                />
                {isSlugAutoGenerated && (
