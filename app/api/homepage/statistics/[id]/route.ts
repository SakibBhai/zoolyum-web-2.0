...
// GET /api/homepage/statistics/[id] - Get a specific statistic
...
// PUT /api/homepage/statistics/[id] - Update a specific statistic (Admin only)
...
// DELETE /api/homepage/statistics/[id] - Delete a specific statistic (Admin only)
